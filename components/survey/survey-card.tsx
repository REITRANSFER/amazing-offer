...
export function SurveyCard() {
        ...
        if (typeof window !== 'undefined' && (window as { fbq?: (...args: unknown[]) => void }).fbq) {
          ...
          if (qualified) {
            fbq('track', 'Lead', {
              ...
              content_name: 'Amazing Offer Survey', content_category: 'real_estate',
  ...
  const handleAddressSelect = (address: string, details: AddressDetails) => {
    ...
    // Auto-advance to next step after address selection (only if in Maricopa County, AZ area)
    setTimeout(() => {
      setStep(2)
    }, 300)
  }
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription className="text-center pt-2">
              We currently only buy houses in the <strong>Maricopa County, Arizona</strong> area and surrounding suburbs.
            </DialogDescription>
          </DialogHeader>
